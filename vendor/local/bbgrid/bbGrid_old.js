...
<<<<<<< HEAD
    viewOptions = ['autofetch', 'buttons', 'actions', 'colModel', 'container',
        'enableSearch','loadDynamic','postdata', 'multiselect', 'rows', 'rowList', 'selectedRows',
=======
    viewOptions = ['autofetch', 'loadDynamic','buttons', 'actions', 'colModel', 'container',
        'enableSearch', 'multiselect', 'rows', 'rowList', 'selectedRows',
>>>>>>> 16d077b9ae3e64f7d001986341b26238e0389aa5
...
=======
                ...
                if (!_.isEmpty(this.filterOptions)) {
                    //data.filter = $.toJSON(this.filterOptions);
                    data.filter = JSON.stringify(this.filterOptions);
                }
                if (this.sortSequence && this.sortSequence.length) {
                    //data.sort = $.toJSON(this.sortSequence);
                    data.sort = JSON.stringify(this.sortSequence);
>>>>>>> 16d077b9ae3e64f7d001986341b26238e0389aa5
                }
...
<<<<<<< HEAD
            console.log("sorted by "+ col.title);
=======
>>>>>>> 16d077b9ae3e64f7d001986341b26238e0389aa5
